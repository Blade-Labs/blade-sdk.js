...
void (async () => {
     ...
     */
    const tokens = [process.env.TOKEN_ID0, process.env.TOKEN_ID1];
        ...
        (
            await (
                await new TransferTransaction()
                    ...
                    .setTransactionMemo(
                        `3*5 Hbar. ${accounts[0].id} -> ${accounts[1].id} + ${accounts[2].id} + ${accounts[3].id}`
                    )
                    .execute(client)
            ).getReceipt(client)
        ).status.toString()
        ...
        (
            await (
                await new TransferTransaction()
                    ...
                    .setTransactionMemo(
                        `3*5 token. ${accounts[0].id} -> ${accounts[1].id} + ${accounts[2].id} + ${accounts[3].id}`
                    )
                    .execute(client)
            ).getReceipt(client)
        ).status.toString()
        ...
        (
            await (
                await new TransferTransaction()
                    ...
                    .addHbarTransfer(accounts[3].id, 5)
                    .setTransactionMemo(
                        `3*5 Hbar. ${accounts[2].id} -> ${accounts[0].id} + ${accounts[1].id} + ${accounts[3].id}`
                    )
                    .execute(client)
            ).getReceipt(client)
        ).status.toString()
        ...
        (
            await (
                await new TransferTransaction()
                    ...
                    .setTransactionMemo(
                        `3*15 Token. ${accounts[2].id} -> ${accounts[0].id} + ${accounts[1].id} + ${accounts[3].id}`
                    )
                    .execute(client)
            ).getReceipt(client)
        ).status.toString()
