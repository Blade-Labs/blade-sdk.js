...
describe('test chain-agnostic functionality', () => {
    ...
    test('bladeSdk-chainAgnostic.getCoinList', async () => {
    ...
    test('bladeSdk-chainAgnostic.getCoinPrice', async () => {
    ...
    // test('bladeSdk-chainAgnostic.transferHbars', async () => {
    ...
    // }, 60_000);
    //
    // test('bladeSdk-chainAgnostic.contractCallFunction', async () => {
    ...
    // }, 120_000);
    //
    // test('bladeSdk-chainAgnostic.contractCallQueryFunction', async () => {
    //     const contractId = process.env.CONTRACT_ID || "";
    //     expect(contractId).not.toEqual("");
    //     const client = Client.forTestnet();
    //     client.setOperator(accountId, privateKey);
    ...
    // }, 120_000);
    //
    // test('bladeSdk-chainAgnostic.transferTokens', async () => {
    //     const client = Client.forTestnet();
    //     client.setOperator(accountId, privateKey);
    //
    ...
    //         const tokenInfo = await apiService.requestTokenInfo(token.tokenId);
    ...
    // }, 120_000);
    //
    // test('bladeSdk-chainAgnostic.createAccount', async () => {
    //     let result = await bladeSdk.init(process.env.API_KEY, process.env.NETWORK, process.env.DAPP_CODE, process.env.VISITOR_ID, process.env.SDK_ENV, sdkVersion, completionKey);
    //     checkResult(result);
    //
    ...
    // }, 60_000);
    //
    // test('bladeSdk-chainAgnostic.getAccountInfo', async () => {
    //     let result = await bladeSdk.init(process.env.API_KEY, process.env.NETWORK, process.env.DAPP_CODE, process.env.VISITOR_ID, process.env.SDK_ENV, sdkVersion, completionKey);
    //     checkResult(result);
    //
    ...
    // }, 60_000);
    //
    // test('bladeSdk-chainAgnostic.deleteAccount', async () => {
    //     let result = await bladeSdk.init(process.env.API_KEY, process.env.NETWORK, process.env.DAPP_CODE, process.env.VISITOR_ID, process.env.SDK_ENV, sdkVersion, completionKey);
    //     checkResult(result);
    //
    //     result = await bladeSdk.createAccount("device-id", completionKey);
    ...
    // }, 60_000);
    //
    // test('bladeSdk-chainAgnostic.getKeysFromMnemonic', async () => {
    ...
    // }, 60_000);
    //
    test('bladeSdk-chainAgnostic.sign + signVerify', async () => {
        const message = "hello";
        ...
        // invalid private key
        try {
            const resultInvalid = await bladeSdk.sign(messageString, `privateKey`, completionKey);
        } catch (resultInvalid) {
        ...
        try {
            const resultInvalid = await bladeSdk.signVerify(messageString, "invalid signature", "invalid publicKey", completionKey);
        } catch (resultInvalid) {
            checkResult(resultInvalid, false);
        }
    });
    //
    // test('bladeSdk-chainAgnostic.ethersSign', async () => {
    //     const message = "hello";
    //     const messageString = Buffer.from(message).toString("base64");
    ...
    // });
    //
    // test('bladeSdk-chainAgnostic.splitSignature', async () => {
    //     const message = "hello";
    //     const messageString = Buffer.from(message).toString("base64");
    //
    //     let result = await bladeSdk.ethersSign(messageString, privateKey, completionKey);
    ...
    // });
    //
    // test('bladeSdk-chainAgnostic.getParamsSignature', async () => {
    ...
    // });
    //
    // test('bladeSdk-chainAgnostic.getTransactions', async () => {
    //     // make transaction
    ...
    // }, 30_000);
    //
    // test('bladeSdk-chainAgnostic.getC14url', async () => {
    //     let result = await bladeSdk.init(process.env.API_KEY, process.env.NETWORK, process.env.DAPP_CODE, process.env.VISITOR_ID, process.env.SDK_ENV, sdkVersion, completionKey);
    //     checkResult(result);
    //
    ...
    // });
    //
    // test('bladeSdk-chainAgnostic.exchangeGetQuotes', async () => {
    ...
    // }, 50_000);
    //
    // test('bladeSdk-chainAgnostic.swapTokens', async () => {
    //     let result = await bladeSdk.init(
    //         process.env.API_KEY,
    //         process.env.NETWORK,
    //         process.env.DAPP_CODE,
    ...
    // }, 60_000);
    //
    // test('bladeSdk-chainAgnostic.getTradeUrl', async () => {
    //     let result = await bladeSdk.init(
    //         process.env.API_KEY_MAINNET,
    //         "mainnet",
    //         process.env.DAPP_CODE,
    ...
    //
    // // create token
    // test('bladeSdk-chainAgnostic.createToken', async () => {
    ...
    //
    //     await sleep(20_000);
    //     const tokenInfo = await apiService.requestTokenInfo(tokenId);
    //
